        ...
        <div className="grid gap-6 md:grid-cols-2">
          ...
          <div className="relative overflow-hidden rounded-2xl border border-ocean-500/20 bg-gradient-to-br from-ocean-500/10 via-ink-900/50 to-ink-950 p-8 animate-fade-up">
            ...
            <p className="mt-3 text-sm leading-relaxed text-ink-300">
              I’m especially interested in full-stack work, AWS-backed data
              platforms, and AI-native tooling. Happy to chat about an
              opportunity, a collaboration, or a tricky problem you’re trying
              to untangle.
            </p>
            <a
          ...
          <div className="rounded-2xl border border-ink-800/60 bg-ink-900/40 p-8 animate-fade-up">
            ...
            <Row label="Phone"    value={profile.phone} href={`tel:${profile.phone.replace(/[^+\d]/g, '')}`} />
            <Row label="LinkedIn" value="/-islammonirul" href={profile.links.linkedin} />
            <Row label="Location" value={profile.location} />
            <Row label="Résumé"   value="Download PDF" href={profile.links.resume} />
